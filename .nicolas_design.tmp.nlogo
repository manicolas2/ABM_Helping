...
(Scope/Question)
	What are the factors that will affect the probability of people helping others?
	What is the average age of people who tend to help more?
	Do women help more than men?

## 2. What are the principal types of agents involved in this phenomenon?
(what rules the agents use to create the overall behavior of the model)
	There will be two principal types of agents: One will be the people who need help and second is the people who are going to help.

## 3. What properties do these agent have (by agent type)?
(Agent types and their properties)
	Age, Gender, Scenario, Health Condition, Social Status (Capability to help)

## 4. What actions or behaviors can these agents take (by agent type)? How do these agents interact with each other or with the environment?
(Agent types and their behaviors)
	Help-seekers receive help from helpers while helpers can receive gratification after helping others.

## 5. In what kind of environment do these agents operate? Are there environmental agents? 
(Environment)
	The simulation will happen at the University of the Philippines - Los Banos. There will be links for people to monitor if they are related or not. 
## 6. If you had to define the phenomenon as discrete time steps, what events would occur in each time step, and in what order? 
(Time Step)
	There will be two events that can be implemented. The first is the helpers will move around together with the people who needs help and the second is the helpers will move around but the people who needs help will stay in place. I will implement a chooser for this.

## 7. What do you hope to observe from this model? 
(Inputs and Outputs)
	I hope to observe the biases present in helping.  e.g. the average age of people who will tend to help people more, the distribution of the amount of help given by gender.
